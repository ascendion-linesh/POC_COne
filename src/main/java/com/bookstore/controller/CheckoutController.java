...
public class CheckoutController {
    ...
    public String checkoutPost(
            ...
            @ModelAttribute("billingAddress") @Valid BillingAddress billingAddress, 
            @ModelAttribute("payment") @Valid Payment payment,
            @RequestParam("billingSameAsShipping") @NotBlank String billingSameAsShipping,
            @RequestParam("shippingMethod") @NotBlank String shippingMethod, 
    ...
    public String setShippingAddress(
        ...
        if (userShipping == null || !userShipping.getUser().getId().equals(user.getId())) {
            return "badRequestPage";
        }
